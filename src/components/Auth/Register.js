                        ...
                        <div class="mt-6">
                            <form onSubmit={(event) => {
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <input id="nombre" name="nombre" type="nombre" autocomplete="nombre" required class="appearance-none bg-neutral-300 font-mono block w-full px-3 py-2 border border-violet-400 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-neutral-300 focus:border-emerald-700 text-xs" />
                                    </div>
                                </div>
